...
path = './app/src/main/java/com/focusbyrj/app/util/AyvaTalkEngine.kt'
with open(path, 'r') as f:
    code = f.read()

target_str = """        // --- 4. INTENT EXTRACTION (e.g. "set wait timer to 15") ---
...
replacement_str = """        // --- 4. INTENT EXTRACTION (e.g. "set wait timer to 15") ---
